...
export class ParentFormComponent implements OnInit {
  ...
  constructor(
    ...
    console.log("this.studService.sAddParent=" + this.studService.sAddParent);
    if (this.studService.sAddParent==true) {
     
      this.returnUrl = '/parents/index';
      this.studService.sAddParent = false;
    }
  ...
  addParent() {
    this.service.addParent(this.formG.value).subscribe(
      res => {
  ...
  submit() {
    ...
    if (!this.formG.valid) {
      this.validator.markFormTouched(this.formG);
      return;
    }
  ...
  public get name(): AbstractControl {
    return this.formG.get('firstName');
  }
  ...
  */
  ...
  updateParent() {
    this.service.updateParent(this.id, this.formG.value).subscribe(
      res => {
  ...
  setupUpdate() {
    this.route.params.subscribe(params => {
      ...
      this.service.getParentById(this.id).subscribe(res => {
        console.log('this is res in set',res);
        
        this.formG = this.validator.patchForm(this.formG, res);
        console.log(res);
      }, err => console.log(err),
        () => this.loading = false);
    });
