...
export class LookupsApiService {
  ...
  getConstantsStatus(): Observable<Lkplookup[]> {
    return this.http.get<Lkplookup[]>(this.apiUrl+"/GetConstantsStatus", environment.httpOptions);
  }
